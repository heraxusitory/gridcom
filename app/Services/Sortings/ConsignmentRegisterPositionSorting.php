...
class ConsignmentRegisterPositionSorting extends QuerySorting
{
    ...
    public function consignment_number()
    {
        return $this->builder
            ->leftJoin('consignments', 'consignment_register_positions.consignment_id', '=', 'consignments.id')
            ->orderBy('consignments.number', $this->order);
    }

    public function mnemocode()
    {
        return $this->builder
            ->leftJoin('nomenclature', 'consignment_register_positions.nomenclature_id', '=', 'nomenclature.id')
    ...
    {
        return $this->builder->orderBy('result_status', $this->order);
    }
