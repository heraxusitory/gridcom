...
class PriceNegotiationTransformer extends TransformerAbstract
{
    ...
    public function transform(PriceNegotiation $price_negotiation)
    {
        return [
            ...
            'file_exists' => /*$price_negotiation?->file_url ? Storage::disk('public')->url($price_negotiation->file_url) : $price_negotiation?->file_url*/Storage::exists($price_negotiation->file_url),
        ];
    }
